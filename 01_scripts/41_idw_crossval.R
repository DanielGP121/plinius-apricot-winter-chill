...
# the same three parameters script 19 uses (radius 50 km, power 2, at most 12 neighbours), so the
...
#
# Usage: Rscript 41_idw_crossval.R [--res 1000] [--sits all|base] [--no-check]
