...
Usage:
    ...
    python 12_pnacc_to_tables.py --root "$PLINIUS_DATA/02_escenarios_pnacc/murcia" --inspect-only

    # 2) full extraction to tidy tables (one file per scenario)
    python 12_pnacc_to_tables.py --root "$PLINIUS_DATA/02_escenarios_pnacc/murcia" \
