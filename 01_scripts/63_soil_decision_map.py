...
Inputs:
  --stations  stations.csv (station_id, lon, lat, WGS84) from 12_pnacc_to_tables.py
...
Usage:
  python 63_soil_decision_map.py --stations "$PLINIUS_DATA/tables/murcia/stations.csv" \
...
# CORINE 100 m grid codes (1..44 legend), same convention as 62_cropland_filter.py.
