...
#
# Usage: Rscript 71_cropland_viability_national.R [--res 1000] [--quick]
...
# Class selection and its verification live in 00_corine.R, shared with 50_scenario_frames.R so the
