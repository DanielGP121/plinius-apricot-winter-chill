...
Inputs:
  --stations  stations.csv with columns station_id, lon, lat (WGS84), from 12_pnacc_to_tables.py
...
Usage:
  python 62_cropland_filter.py --stations "$PLINIUS_DATA/tables/murcia/stations.csv" \
