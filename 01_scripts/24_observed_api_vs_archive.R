...
# (script 15 --per-season) has 3044 stations but stops in 2020; the AEMET API record (script 23) runs
...
#
# Usage:
#   Rscript 24_observed_api_vs_archive.R
#   Rscript 24_observed_api_vs_archive.R --min-perc 90 --min-seasons 10
#
