...
Usage (Ladon):
    python3 11_aemet_observed_download.py --probe --stations stations_obs.txt
    nohup python3 11_aemet_observed_download.py --stations stations_obs.txt \\
        --out obs_api --from 1995 --to 2025 --chunk-months 6 > obs_download.log 2>&1 &
    python3 11_aemet_observed_download.py --merge --out obs_api --csv observed_1995_2025.csv
"""
