...
#   THREDDS (projections, from script 10): tas* is [time x station], 'station' is a coordinate
...
#
# File layout expected in --data (from THREDDS, script 10):
...
#
# Usage (Ladon):
#   Rscript 20_chill_national_parallel.R --data <dir> --obs <dir> --check          # pre-flight, no compute
#   Rscript 20_chill_national_parallel.R --data <dir> --obs <dir> --maxst 40 ...   # smoke test, own paths
#   nohup Rscript 20_chill_national_parallel.R --data <dir> --obs <dir> --cores 10 > chill.log 2>&1 &
#   Rscript 20_chill_national_parallel.R --obs <dir> --windows obs --per-season \
#         --outdir chill_parts_obs_seasons --out chill_obs_seasons.csv --cores 10
#   Rscript 20_chill_national_parallel.R --obs <dir> --windows obs --per-season --years 1975,2020 \
#         --outdir chill_parts_obs_seasons_long --out chill_obs_seasons_1975.csv --cores 10
#   nohup Rscript 20_chill_national_parallel.R --data <dir> --windows present --outdir parts_present \
#         --out chill_present.csv --cores 10 > chill_present.log 2>&1 &
#   nohup Rscript 20_chill_national_parallel.R --data <dir> --windows near --outdir parts_near \
#         --out chill_near.csv --cores 10 > chill_near.log 2>&1 &
#   Rscript 20_chill_national_parallel.R --merge-only --outdir <dir> --out <csv>   # rebuild the table
#
