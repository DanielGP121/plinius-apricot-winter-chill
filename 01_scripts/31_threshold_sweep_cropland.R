...
#   (script 44). If the requirements were quantified on the 1988 scale, every threshold used here
...
#
# Interpolation, cropland mask and ensemble handling are identical to 30_cropland_viability_national.R
...
#
# Usage:
#   Rscript 50_threshold_sweep_cropland.R
#   Rscript 50_threshold_sweep_cropland.R --quick --from 30 --to 60 --by 1
#
...
# The 1988-minus-1987 gap is measured by script 44, so it is read from that script's output rather
...
# --- § 2 - template and cropland fraction, identical to script 30 -----------------------------
...
# Restating the open question of script 44 in the currency the talk uses. Not a claim that the
