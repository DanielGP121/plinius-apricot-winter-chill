#!/usr/bin/env Rscript
# ---------------------------------------------------------------------------------------
# Binary cropland maps at native 100 m (cropland / non-cropland), national and Murcia, with and
# without the AEMET stations. Companion to the 500 m maps (script 67); these keep the full
...
#
# Usage: Rscript 68_cropland_binary_100m.R
...
# 100 m binary as a categorical raster (cropland / non-cropland), masked to the region
